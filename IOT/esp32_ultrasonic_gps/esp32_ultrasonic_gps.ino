...
void displayInfo()
{
  if (gps.location.isValid())
  {
    ...
    if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 5000 || sendDataPrevMillis == 0))
    {
      ...
      if (Firebase.RTDB.setFloat(&fbdo, "bin1/Sensor/LevelWater", distance))
      {
        Serial.println();
      ...
      if (Firebase.RTDB.setFloat(&fbdo, "bin1/gps/latitude", latitude))
      {
        Serial.println();
        Serial.print(latitude);
        Serial.println("- successfully saved to:");
      ...
      if (Firebase.RTDB.setFloat(&fbdo, "bin1/gps/longitude", longitude))
      {
        Serial.println();
        Serial.print(longitude);
        Serial.println("- successfully saved to:");
      ...
      if (Firebase.RTDB.setString(&fbdo, "bin1/googlemaps/link", googleMapsLink))
      {
        Serial.println();
